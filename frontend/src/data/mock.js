...
export const VIDEOS_DATA = {
  ...
  channelUrl: 'https://www.youtube.com/@zahraturkishicecream',
  videos: [
    {
      id: 'steyIxjK-pM',
      title: 'Zahra - Turkish Ice Cream, TSM Bandung',
      description: '843K views • Our most popular performance',
    },
    {
      id: 'vnr23gz8vME',
      title: 'ZAHRA Turkish Ice Cream Show',
      description: 'Experience the fun and entertainment',
    },
    {
      id: 'AEgnWpgsa-Q',
      title: 'ZAHRA Turkish Ice Cream PRJ',
      description: '20K views • Pekan Raya Jakarta event',
    },
    {
      id: 'tMXqe3dKApc',
      title: 'Zahra - Turkish Ice Cream',
      description: '11K views • Kota Kasablanka Mall Jakarta',
    },
    {
      id: 'eWm4Pn4hiW0',
      title: 'Zahra Turkish Ice Cream Indonesia',
      description: '3.2K views • Bandung performance',
    },
    {
      id: 'ZYPg3xmCnH8',
      title: 'First Zahra Experience at Mal Kelapa Gading',
      description: 'Our early days in 2011',
    },
  ],
};
